...
@Service("documentParserXml")
public class DocumentParserXML implements DocumentParser {
    public PaymentList parseFromURL(String url){
        Document doc;
        try {
    ...
    private PaymentList parseFromDocument(Document document){
        ...
        List<List<String>> currentChartData = new LinkedList<>();
...
//        System.out.println(tableString.text());
        Iterator<Element> cellIterator = tableString.select("Cell").iterator();
